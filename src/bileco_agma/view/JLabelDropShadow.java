 ...
 * @author Balo Family
 */
public class JLabelDropShadow extends JLabel {
    private final int tracking;

    public JLabelDropShadow(String text, int tracking) {
        super(text);
    ...
    public Dimension getPreferredSize() {
         ...
         strWidth += (text.length() - 1) * tracking;
         strWidth += left_x + right_x;
         int height = fm.getHeight();
         height += left_y + right_y;

         return new Dimension(strWidth, height);
}
    ...
    public static void main(String[] args) {
        ...
        JLabelDropShadow label = new JLabelDropShadow("100", 0);
